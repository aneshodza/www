...
export const ui = {
  de: {
    ...
    'contact.form.title': 'Betreff',
    'contact.form.message': 'Nachricht',
    'contact.form.send': 'Nachricht senden',
    'contact.form.error.required': 'Dieses Feld ist erforderlich.',
    'contact.form.error.email': 'Bitte eine gültige E-Mail-Adresse eingeben.',
    'contact.form.sending': 'Wird gesendet…',
    'contact.form.success': 'Danke! Deine Nachricht ist angekommen. Ich melde mich bald.',
    'contact.form.error.submit':
      'Senden fehlgeschlagen. Bitte versuche es erneut oder schreib mir direkt per E-Mail.',
  ...
  en: {
    ...
    'contact.form.success': 'Thanks! Your message has been sent. I will get back to you soon.',
    'contact.form.error.submit':
